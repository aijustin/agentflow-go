...
**最新发布：[v0.4.2](CHANGELOG.md)** — 新增 deferred tool catalog、observation masking 与强制 fencing；v0.3 起适配器与 HTTP 构造器拆至 `pkg/adapters` / `pkg/httpx`。完整变更见 [CHANGELOG.md](CHANGELOG.md)。
